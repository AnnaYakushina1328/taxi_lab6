...
В системе остаются основные сущности:
...
Consumer обновляет отдельную read-модель на основе событий. В этой лабораторной она хранится в JSON-файле, чтобы результат было легко проверить.
